                  ...
                  <div className="bg-white rounded-[12px] border border-[#e1e3ea] p-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleDownloadPDF(selectedContract.content, selectedContract.title)} className="px-4 py-2 bg-primary text-white rounded-lg text-xs font-semibold">PDF</button>
                        <button onClick={() => handleDownloadText(selectedContract.content, selectedContract.title)} className="px-4 py-2 border border-primary text-primary rounded-lg text-xs font-semibold">TXT</button>
                      </div>
                    </div>
